...
GLOBAL.GLOBALPAUSE.LANGUAGE = GetModConfigData('LANGUAGE') or "en"
...
if GLOBALPAUSE.LANGUAGE == "zh" then
    STRINGS.UI.PAUSEMENU.PAUSED_DST_TITLE = "暂停！"
    STRINGS.UI.PAUSEMENU.PAUSED_DST_SUBTITLE = "不开玩笑。它已经停下来了！"
    STRINGS.UI.PAUSEMENU.TOGGLE_PAUSE = "切换暂停"
    STRINGS.UI.PAUSEMENU.CLIENT_VOTE_PAUSE = "投票暂停"
    STRINGS.UI.PAUSEMENU.CLIENT_VOTE_UNPAUSE = "投票取消暂停"
-- you can add more language by adding:
-- elseif GLOBALPAUSE.LANGUAGE == "xx" then
else
