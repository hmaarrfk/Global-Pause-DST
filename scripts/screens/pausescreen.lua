...
local PauseScreen = Class(Screen, function(self)
    ...
    self.bg = self.proot:AddChild(TEMPLATES.CurlyWindow(-40, 236+extra_menu_height, 0.75, 0.75, 50, -31))
    ...
    self.subtitle:SetPosition(0, 75+extra_menu_height/2, 0)
    ...
    self.menu:SetPosition(0, 35 + extra_menu_height/2, 0)
...
function PauseScreen:PauseText()
  self.title:SetString("Paused!")
  self.subtitle:SetString("Seriously. It is!")
end
